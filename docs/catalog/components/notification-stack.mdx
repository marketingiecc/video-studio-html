...
<CatalogDetail
  ...
  meta={{"category":"Product Demo","badge":"Stable","codeLines":387}}
  attribution={{"path":"registry/components/notification-stack","tags":["motion-primitive","product-demo","notification","stack","stagger"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/notification-stack/notification-stack.html"
>
