...
<CatalogDetail
  ...
  meta={{"category":"Product Demo","badge":"Stable","codeLines":553}}
  attribution={{"path":"registry/components/telemetry-hud","tags":["motion-primitive","product-demo","hud","telemetry","deterministic"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/telemetry-hud/telemetry-hud.html"
>
