...
<CatalogDetail
  ...
  meta={{"category":"Product Demo","badge":"Stable","codeLines":363}}
  attribution={{"path":"registry/components/state-chip-rail","tags":["motion-primitive","product-demo","state-machine","status","chips","rail"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/state-chip-rail/state-chip-rail.html"
>
