...
<CatalogDetail
  ...
  meta={{"category":"Motion Primitives","badge":"Stable","codeLines":238}}
  attribution={{"path":"registry/components/separator","tags":["video-primitive","separator","layout"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/separator/separator.html"
>
