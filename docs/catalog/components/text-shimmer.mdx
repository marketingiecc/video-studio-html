...
<CatalogDetail
  ...
  meta={{"category":"Typography & Text","badge":"Stable","codeLines":178}}
  attribution={{"path":"registry/components/text-shimmer","tags":["motion-primitive","text-effects","shimmer","specular","emphasis"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/text-shimmer/text-shimmer.html"
>
