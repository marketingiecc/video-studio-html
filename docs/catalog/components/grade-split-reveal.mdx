...
<CatalogDetail
  ...
  meta={{"category":"Motion Scenes","badge":"Stable","codeLines":446}}
  attribution={{"path":"registry/components/grade-split-reveal","tags":["color-grading","media","compare","reveal","motion-primitive","grade"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/grade-split-reveal/grade-split-reveal.html"
>
