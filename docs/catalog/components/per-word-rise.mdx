...
<CatalogDetail
  ...
  meta={{"category":"Typography & Text","badge":"Stable","codeLines":316}}
  attribution={{"path":"registry/components/per-word-rise","tags":["motion-primitive","text-effects","typography","stagger","reveal"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/per-word-rise/per-word-rise.html"
>
