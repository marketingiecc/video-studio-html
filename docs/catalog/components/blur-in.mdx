...
<CatalogDetail
  ...
  meta={{"category":"Motion Primitives","badge":"Stable","codeLines":239}}
  attribution={{"path":"registry/components/blur-in","tags":["video-primitive","blur-in","text-effect"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/blur-in/blur-in.html"
>
