...
<CatalogDetail
  ...
  meta={{"category":"Product Demo","badge":"Stable","codeLines":648}}
  attribution={{"path":"registry/components/browser-device-stage","tags":["stage","product-demo","device","browser","phone","slot","chrome"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/browser-device-stage/browser-device-stage.html"
>
