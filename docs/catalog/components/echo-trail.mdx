...
<CatalogDetail
  ...
  meta={{"category":"Product Demo","badge":"Stable","codeLines":353}}
  attribution={{"path":"registry/components/echo-trail","tags":["motion-primitive","demonstrate","trail","onion-skin","ghosts","deterministic"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/echo-trail/echo-trail.html"
>
