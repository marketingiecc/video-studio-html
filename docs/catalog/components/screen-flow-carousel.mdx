...
<CatalogDetail
  ...
  meta={{"category":"Product Demo","badge":"Stable","codeLines":576}}
  attribution={{"path":"registry/components/screen-flow-carousel","tags":["product-demo","feature-tour","carousel","rail","slot","screens"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/screen-flow-carousel/screen-flow-carousel.html"
>
