...
<CatalogDetail
  previewSrc="/public/catalog/components/mk-usage-arc.json"
  compositionId="mk-usage-arc"
  compositionSrc="compositions/components/mk-usage-arc.html"
  title="Hairline Arc Gauge"
  description="Thin circular gauge that draws on while its percentage counts up; one helper call drives both"
  variables={[]}
  meta={{"category":"Effects","badge":"Stable","codeLines":159}}
  attribution={{"path":"registry/components/mk-usage-arc","tags":["data-viz","gauge","minimal"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/mk-usage-arc/mk-usage-arc.html"
>

<CatalogSlot slot="code">

```html mk-usage-arc.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
