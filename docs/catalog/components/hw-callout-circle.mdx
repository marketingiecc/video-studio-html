...
<CatalogDetail
  previewSrc="/public/catalog/components/hw-callout-circle.json"
  compositionId="hw-callout-circle"
  compositionSrc="compositions/components/hw-callout-circle.html"
  title="Scribble Callout Circle"
  description="Wobbled ellipse draws around a target with optional scribble fill and curved connector; the handwritten label pops in WITH momentum and the drawn shapes absorb the arrival with a volume-preserving contact squash; outline and connector take the family stroke matrix (plain/soft/sharp/spray); boils"
  variables={[]}
  meta={{"category":"Effects","badge":"Stable","codeLines":623}}
  attribution={{"path":"registry/components/hw-callout-circle","tags":["handwritten","annotation","callout","overlay"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/hw-callout-circle/hw-callout-circle.html"
>

<CatalogSlot slot="code">

```html hw-callout-circle.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
