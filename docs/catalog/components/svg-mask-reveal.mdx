...
<CatalogDetail
  ...
  meta={{"category":"Effects","badge":"Stable","codeLines":316}}
  attribution={{"path":"registry/components/svg-mask-reveal","tags":["effect","svg","mask","wordmark","reveal","exhibit"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/svg-mask-reveal/svg-mask-reveal.html"
>
