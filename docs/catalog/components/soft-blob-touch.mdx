...
<CatalogDetail
  ...
  meta={{"category":"Product Demo","badge":"Stable","codeLines":515}}
  attribution={{"path":"registry/components/soft-blob-touch","tags":["motion-primitive","product-demo","material","blob","touch","grain"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/soft-blob-touch/soft-blob-touch.html"
>
