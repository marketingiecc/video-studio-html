...
<CatalogDetail
  ...
  meta={{"category":"Product Demo","badge":"Stable","codeLines":517}}
  attribution={{"path":"registry/components/segmentation-flood","tags":["motion-primitive","product-demo","ai","hud","canvas","deterministic","experiment"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/segmentation-flood/segmentation-flood.html"
>
