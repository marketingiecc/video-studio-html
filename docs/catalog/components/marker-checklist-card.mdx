...
<CatalogDetail
  ...
  meta={{"category":"Motion Scenes","badge":"Stable","codeLines":306}}
  attribution={{"author":"Miao Yang","path":"registry/components/marker-checklist-card","tags":["motion-primitive","handwritten","checklist","paper","marker"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/marker-checklist-card/marker-checklist-card.html"
>
