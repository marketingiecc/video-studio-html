...
<CatalogDetail
  previewSrc="/public/catalog/components/hw-underline.json"
  compositionId="hw-underline"
  compositionSrc="compositions/components/hw-underline.html"
  title="Squiggle Marks"
  description="Hand-drawn squiggle underline, double-pass strikethrough, and bracket marks that draw on"
  variables={[]}
  meta={{"category":"Effects","badge":"Stable","codeLines":257}}
  attribution={{"path":"registry/components/hw-underline","tags":["handwritten","annotation","text-treatment"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/hw-underline/hw-underline.html"
>

<CatalogSlot slot="code">

```html hw-underline.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
