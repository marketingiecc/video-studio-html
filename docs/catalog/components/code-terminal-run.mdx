...
<CatalogDetail
  ...
  meta={{"category":"Product Demo","badge":"Stable","codeLines":560}}
  attribution={{"path":"registry/components/code-terminal-run","tags":["motion-primitive","product-demo","terminal","typing","deterministic"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/code-terminal-run/code-terminal-run.html"
>
