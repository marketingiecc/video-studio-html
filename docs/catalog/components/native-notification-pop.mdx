...
<CatalogDetail
  ...
  meta={{"category":"Product Demo","badge":"Stable","codeLines":456}}
  attribution={{"path":"registry/components/native-notification-pop","tags":["motion-primitive","product-demo","overlay","notification","spring"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/native-notification-pop/native-notification-pop.html"
>
