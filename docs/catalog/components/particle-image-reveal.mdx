...
<CatalogDetail
  ...
  meta={{"category":"Motion Scenes","badge":"Stable","codeLines":392}}
  attribution={{"path":"registry/components/particle-image-reveal","tags":["motion-primitive","intros-reveals","particles","reveal","canvas","deterministic"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/particle-image-reveal/particle-image-reveal.html"
>
