...
<CatalogDetail
  ...
  meta={{"category":"Product Demo","badge":"Stable","codeLines":679}}
  attribution={{"path":"registry/components/pull-to-refresh","tags":["pointer","pointers","mobile","gesture","interaction","refresh","demonstrate"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/pull-to-refresh/pull-to-refresh.html"
>
