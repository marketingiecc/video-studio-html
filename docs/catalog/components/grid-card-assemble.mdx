...
<CatalogDetail
  ...
  meta={{"category":"Motion Scenes","badge":"Stable","codeLines":468}}
  attribution={{"path":"registry/components/grid-card-assemble","tags":["motion-primitive","layout","grid","list","stagger","assemble","feature-tour"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/grid-card-assemble/grid-card-assemble.html"
>
