...
<CatalogDetail
  ...
  meta={{"category":"Product Demo","badge":"Stable","codeLines":384}}
  attribution={{"path":"registry/components/typed-prompt","tags":["motion-primitive","product-demo","typing","prompt","deterministic"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/typed-prompt/typed-prompt.html"
>
