...
<CatalogDetail
  ...
  meta={{"category":"Texture","badge":"Stable","codeLines":447}}
  attribution={{"path":"registry/components/ink-bleed-reveal","tags":["motion-primitive","texture","reveal","gooey","svg-filter","deterministic","experiment"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/ink-bleed-reveal/ink-bleed-reveal.html"
>
