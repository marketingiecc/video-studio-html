...
<CatalogDetail
  ...
  meta={{"category":"Motion Scenes","badge":"Stable","codeLines":422}}
  attribution={{"path":"registry/components/oversized-cursor","tags":["motion-primitive","actor","cursor","pointer","interaction"]}}
  hasCode
