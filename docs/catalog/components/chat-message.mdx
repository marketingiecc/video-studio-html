...
<CatalogDetail
  ...
  meta={{"category":"Motion Primitives","badge":"Stable","codeLines":304}}
  attribution={{"author":"Miao Yang","path":"registry/components/chat-message","tags":["video-primitive","chat","mock-ui","message"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/chat-message/chat-message.html"
>
