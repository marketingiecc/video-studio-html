...
<CatalogDetail
  ...
  meta={{"category":"Motion Scenes","badge":"Stable","codeLines":727}}
  attribution={{"path":"registry/components/multi-device-splay","tags":["motion-primitive","device","phone","tablet","desktop","splay"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/multi-device-splay/multi-device-splay.html"
>
