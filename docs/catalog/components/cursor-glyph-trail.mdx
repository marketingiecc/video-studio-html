...
<CatalogDetail
  ...
  meta={{"category":"Product Demo","badge":"Stable","codeLines":390}}
  attribution={{"path":"registry/components/cursor-glyph-trail","tags":["motion-primitive","demonstrate","trail","cursor","glyphs","deterministic"]}}
  hasCode
