...
<CatalogDetail
  ...
  meta={{"category":"Motion Scenes","badge":"Stable","codeLines":173}}
  attribution={{"path":"registry/components/outline-draw","tags":["motion-primitive","effects","outline","border","mask","proof"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/outline-draw/outline-draw.html"
>
