...
<CatalogDetail
  ...
  meta={{"category":"Product Demo","badge":"Stable","codeLines":258}}
  attribution={{"path":"registry/components/icon-morph-beat","tags":["motion-primitive","product-demo","icon","morph","state-change","completion"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/icon-morph-beat/icon-morph-beat.html"
>
