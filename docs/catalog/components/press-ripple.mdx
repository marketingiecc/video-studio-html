...
<CatalogDetail
  ...
  meta={{"category":"Product Demo","badge":"Stable","codeLines":373}}
  attribution={{"path":"registry/components/press-ripple","tags":["motion-primitive","product-demo","cursor","press","ripple","payoff"]}}
  hasCode
