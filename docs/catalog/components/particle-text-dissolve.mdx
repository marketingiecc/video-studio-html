...
<CatalogDetail
  ...
  meta={{"category":"Typography & Text","badge":"Stable","codeLines":414}}
  attribution={{"path":"registry/components/particle-text-dissolve","tags":["motion-primitive","text-effects","particles","canvas","deterministic","experiment"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/particle-text-dissolve/particle-text-dissolve.html"
>
