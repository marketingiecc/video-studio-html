...
<CatalogDetail
  ...
  meta={{"category":"Motion Scenes","badge":"Stable","codeLines":467}}
  attribution={{"path":"registry/components/stop-motion-cadence","tags":["motion-primitive","time-law","stop-motion","stepped","boil","deterministic","experiment"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/stop-motion-cadence/stop-motion-cadence.html"
>
