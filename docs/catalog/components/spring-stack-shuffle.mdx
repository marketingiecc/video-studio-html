...
<CatalogDetail
  ...
  meta={{"category":"Product Demo","badge":"Stable","codeLines":607}}
  attribution={{"path":"registry/components/spring-stack-shuffle","tags":["motion-primitive","product-demo","physics","stack","interruptible-spring"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/spring-stack-shuffle/spring-stack-shuffle.html"
>
