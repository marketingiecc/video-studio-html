...
<CatalogDetail
  ...
  meta={{"category":"Typography & Text","badge":"Stable","codeLines":367}}
  attribution={{"path":"registry/components/logo-brand-close","tags":["motion-primitive","typography","brand","logo","end-card","close"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/logo-brand-close/logo-brand-close.html"
>
