...
<CatalogDetail
  previewSrc="/public/catalog/components/yt-screen-warp.json"
  compositionId="yt-screen-warp"
  compositionSrc="compositions/components/yt-screen-warp.html"
  title="On-Screen Display Effect"
  description="Grid, scanline, vignette, and sheen overlay plus a 3D-warp wrapper class that makes footage read as if playing on a physical display"
  variables={[]}
  meta={{"category":"Texture","badge":"Stable","codeLines":123}}
  attribution={{"path":"registry/components/yt-screen-warp","tags":["effect","overlay","texture"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/yt-screen-warp/yt-screen-warp.html"
>

<CatalogSlot slot="code">

```html yt-screen-warp.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
