...
<CatalogDetail
  ...
  meta={{"category":"Motion Scenes","badge":"Stable","codeLines":378}}
  attribution={{"path":"registry/components/touch-indicator","tags":["motion-primitive","mobile","gesture","touch","pointer"]}}
  hasCode
