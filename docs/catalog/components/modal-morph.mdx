...
<CatalogDetail
  ...
  meta={{"category":"Motion Scenes","badge":"Stable","codeLines":522}}
  attribution={{"path":"registry/components/modal-morph","tags":["motion-primitive","structure","flip","shared-element","modal","deterministic","experiment"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/modal-morph/modal-morph.html"
>
