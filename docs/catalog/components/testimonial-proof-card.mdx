...
<CatalogDetail
  ...
  meta={{"category":"Motion Scenes","badge":"Stable","codeLines":495}}
  attribution={{"path":"registry/components/testimonial-proof-card","tags":["motion-primitive","proof","testimonial","quote","social-proof","deterministic"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/testimonial-proof-card/testimonial-proof-card.html"
>
