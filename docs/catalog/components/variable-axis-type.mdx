...
<CatalogDetail
  ...
  meta={{"category":"Typography & Text","badge":"Stable","codeLines":192}}
  attribution={{"path":"registry/components/variable-axis-type","tags":["typography","variable-font","kinetic-type","axis","emphasize"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/variable-axis-type/variable-axis-type.html"
>
