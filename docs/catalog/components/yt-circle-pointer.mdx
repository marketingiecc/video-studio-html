...
<CatalogDetail
  previewSrc="/public/catalog/components/yt-circle-pointer.json"
  compositionId="yt-circle-pointer"
  compositionSrc="compositions/components/yt-circle-pointer.html"
  title="Pointer Circle + Countdown"
  description="Draw-on annotation ellipse around a target plus a countdown chip that pulses each tick"
  variables={[]}
  meta={{"category":"Effects","badge":"Stable","codeLines":168}}
  attribution={{"path":"registry/components/yt-circle-pointer","tags":["annotation","countdown","overlay"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/yt-circle-pointer/yt-circle-pointer.html"
>

<CatalogSlot slot="code">

```html yt-circle-pointer.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
