...
<CatalogDetail
  ...
  meta={{"category":"Motion Scenes","badge":"Stable","codeLines":297}}
  attribution={{"path":"registry/components/count-up","tags":["motion-primitive","proof","stats","counter","number","deterministic"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/count-up/count-up.html"
>
