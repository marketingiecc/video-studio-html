...
<CatalogDetail
  previewSrc="/public/catalog/blocks/beat-freeze-cut.json"
  compositionId="beat-freeze-cut"
  compositionSrc="compositions/beat-freeze-cut.html"
  title="Beat Freeze Cut"
  description="A beat-driven speed ramp, freeze-frame hit, and hard-cut sequence for music-led promos and montages."
  variables={[]}
  meta={{"duration":6,"width":1920,"height":1080,"category":"CSS Transitions","badge":"Stable","codeLines":879}}
  attribution={{"path":"registry/blocks/beat-freeze-cut","tags":["transition","music","beat-driven","freeze-frame"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/beat-freeze-cut/beat-freeze-cut.html"
>

<CatalogSlot slot="code">

```html beat-freeze-cut.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
