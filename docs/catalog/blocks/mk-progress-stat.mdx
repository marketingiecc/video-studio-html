...
<CatalogDetail
  previewSrc="/public/catalog/blocks/mk-progress-stat.json"
  compositionId="mk-progress-stat"
  compositionSrc="compositions/mk-progress-stat.html"
  title="Count-Up Stat Card"
  description="Big-numeral statistic with count-up, label, thin progress track filling to value/max, and caption; light and dark schemes"
  variables={[]}
  meta={{"duration":7,"width":1920,"height":1080,"category":"Blocks","badge":"Stable","codeLines":185}}
  attribution={{"path":"registry/blocks/mk-progress-stat","tags":["data-viz","stat","minimal"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/mk-progress-stat/mk-progress-stat.html"
>

<CatalogSlot slot="code">

```html mk-progress-stat.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
