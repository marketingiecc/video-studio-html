...
<CatalogDetail
  previewSrc="/public/catalog/blocks/mk-specs-list.json"
  compositionId="mk-specs-list"
  compositionSrc="compositions/mk-specs-list.html"
  title="Specs Checklist"
  description="Left-aligned specs/traits checklist over footage or a board: rows slide in staggered with an accent underline sweep; light and dark schemes"
  variables={[]}
  meta={{"duration":8,"width":1920,"height":1080,"category":"Blocks","badge":"Stable","codeLines":222}}
  attribution={{"path":"registry/blocks/mk-specs-list","tags":["data-viz","list","minimal","professional"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/mk-specs-list/mk-specs-list.html"
>

<CatalogSlot slot="code">

```html mk-specs-list.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
