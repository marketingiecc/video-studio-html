...
<CatalogDetail
  previewSrc="/public/catalog/blocks/hw-text-cloud.json"
  compositionId="hw-text-cloud"
  compositionSrc="compositions/hw-text-cloud.html"
  title="Speech Bubble"
  description="Hand-drawn speech bubble with a positionable tail: outline draws on, paper fill fades in, handwritten text types per character; boils"
  variables={[]}
  meta={{"duration":6,"width":1920,"height":1080,"category":"Blocks","badge":"Stable","codeLines":286}}
  attribution={{"path":"registry/blocks/hw-text-cloud","tags":["handwritten","speech-bubble","overlay"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/hw-text-cloud/hw-text-cloud.html"
>

<CatalogSlot slot="code">

```html hw-text-cloud.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
