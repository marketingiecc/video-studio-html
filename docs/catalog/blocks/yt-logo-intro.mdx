...
<CatalogDetail
  previewSrc="/public/catalog/blocks/yt-logo-intro.json"
  compositionId="yt-logo-intro"
  compositionSrc="compositions/yt-logo-intro.html"
  title="Logo Intro Sequence"
  description="Logo stamp pops on a lined board, a kicker line gives way to the title with an accent arrow chip; seeded line distortion"
  variables={[]}
  meta={{"duration":6,"width":1920,"height":1080,"category":"Blocks","badge":"Stable","codeLines":251}}
  attribution={{"path":"registry/blocks/yt-logo-intro","tags":["logo","intro","creator"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/yt-logo-intro/yt-logo-intro.html"
>

<CatalogSlot slot="code">

```html yt-logo-intro.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
