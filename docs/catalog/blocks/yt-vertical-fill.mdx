...
<CatalogDetail
  previewSrc="/public/catalog/blocks/yt-vertical-fill.json"
  compositionId="yt-vertical-fill"
  compositionSrc="compositions/yt-vertical-fill.html"
  title="Vertical Media Filler"
  description="Portrait media filling a widescreen frame via blurred-scale, mirror, or copy side fills; grid texture and foreground contrast lift (images inside the block; keep live footage in the host)"
  variables={[]}
  meta={{"duration":8,"width":1920,"height":1080,"category":"Blocks","badge":"Stable","codeLines":228}}
  attribution={{"path":"registry/blocks/yt-vertical-fill","tags":["placeholder","vertical","media"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/yt-vertical-fill/yt-vertical-fill.html"
>

<CatalogSlot slot="code">

```html yt-vertical-fill.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
