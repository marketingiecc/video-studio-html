...
<CatalogDetail
  previewSrc="/public/catalog/blocks/hw-write-title.json"
  compositionId="hw-write-title"
  compositionSrc="compositions/hw-write-title.html"
  title="Handwritten Write-On Title"
  description="True glyph write-on: filled Caveat letterforms revealed by baked per-glyph centerline strokes traced in real stroke order with a curvature-adaptive pen-velocity ease (fast on straights, slow into curves, inter-stroke pen lifts); optional squiggle underline; boils"
  variables={[]}
  meta={{"duration":6,"width":1920,"height":1080,"category":"Typography & Text","badge":"Stable","codeLines":500}}
  attribution={{"path":"registry/blocks/hw-write-title","tags":["handwritten","typography","title-card","write-on","overlay"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/hw-write-title/hw-write-title.html"
>

<CatalogSlot slot="code">

```html hw-write-title.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
