...
<CatalogDetail
  previewSrc="/public/catalog/blocks/yt-comment-card.json"
  compositionId="yt-comment-card"
  compositionSrc="compositions/yt-comment-card.html"
  title="Comment Cards"
  description="Social comments typing on over footage: avatar pop, username and time, per-character typewriter, likes row; image avatars or initials chips"
  variables={[]}
  meta={{"duration":8,"width":1920,"height":1080,"category":"Social Overlays","badge":"Stable","codeLines":318}}
  attribution={{"path":"registry/blocks/yt-comment-card","tags":["social","comments","creator","overlay"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/yt-comment-card/yt-comment-card.html"
>

<CatalogSlot slot="code">

```html yt-comment-card.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
