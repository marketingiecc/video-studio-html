...
<CatalogDetail
  previewSrc="/public/catalog/blocks/mk-line-graph.json"
  compositionId="mk-line-graph"
  compositionSrc="compositions/mk-line-graph.html"
  title="Minimal Line Graph"
  description="One or two SVG series draw on with dots popping and value labels riding the draw front; dim baseline axis, x-labels, color-dot legend"
  variables={[]}
  meta={{"duration":7,"width":1920,"height":1080,"category":"Data","badge":"Stable","codeLines":292}}
  attribution={{"path":"registry/blocks/mk-line-graph","tags":["data-viz","chart","graph","minimal"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/mk-line-graph/mk-line-graph.html"
>

<CatalogSlot slot="code">

```html mk-line-graph.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
