...
<CatalogDetail
  previewSrc="/public/catalog/blocks/hw-frame.json"
  compositionId="hw-frame"
  compositionSrc="compositions/hw-frame.html"
  title="Sketched Frame"
  description="Media in a hand-drawn border with corner doodles and a handwritten caption; the unit tilts slightly and boils (images inside the block; keep live footage in the host)"
  variables={[]}
  meta={{"duration":8,"width":1920,"height":1080,"category":"Blocks","badge":"Stable","codeLines":302}}
  attribution={{"path":"registry/blocks/hw-frame","tags":["handwritten","frame","media"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/hw-frame/hw-frame.html"
>
