...
<CatalogDetail
  previewSrc="/public/catalog/blocks/thread-message-stack.json"
  compositionId="thread-message-stack"
  compositionSrc="compositions/thread-message-stack.html"
  title="Thread Message Stack"
  description="A source-owned editable conversation stack with arbitrary incoming and outgoing messages"
  variables={[]}
  meta={{"duration":8,"width":1920,"height":1080,"category":"Social Overlays","badge":"Stable","codeLines":239}}
  attribution={{"path":"registry/blocks/thread-message-stack","tags":["social","conversation","messages"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/thread-message-stack/thread-message-stack.html"
>

<CatalogSlot slot="code">

```html thread-message-stack.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
