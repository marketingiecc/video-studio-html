...
<CatalogDetail
  previewSrc="/public/catalog/blocks/yt-lcd-background.json"
  compositionId="yt-lcd-background"
  compositionSrc="compositions/yt-lcd-background.html"
  title="Scanline Board Background"
  description="Textured paper board: scanlines with slow drift, optional pixel grid, static grain, and display text with a blur-focus entrance and chromatic-fringe title"
  variables={[]}
  meta={{"duration":10,"width":1920,"height":1080,"category":"Texture","badge":"Stable","codeLines":306}}
  attribution={{"path":"registry/blocks/yt-lcd-background","tags":["background","texture","creator"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/yt-lcd-background/yt-lcd-background.html"
>

<CatalogSlot slot="code">

```html yt-lcd-background.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
