...
<CatalogDetail
  previewSrc="/public/catalog/blocks/hw-scribble-transition.json"
  compositionId="hw-scribble-transition"
  compositionSrc="compositions/hw-scribble-transition.html"
  title="Scribble Transition"
  description="Overlay transition: scribble bands accumulate to cover the frame with a solid backstop, the host cuts beneath, and the scribble clears"
  variables={[]}
  meta={{"duration":2.2,"width":1920,"height":1080,"category":"CSS Transitions","badge":"Stable","codeLines":152}}
  attribution={{"path":"registry/blocks/hw-scribble-transition","tags":["handwritten","transition","wipe"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/hw-scribble-transition/hw-scribble-transition.html"
>

<CatalogSlot slot="code">

```html hw-scribble-transition.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
