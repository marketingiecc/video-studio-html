...
<CatalogDetail
  previewSrc="/public/catalog/blocks/yt-prism-title.json"
  compositionId="yt-prism-title"
  compositionSrc="compositions/yt-prism-title.html"
  title="Chromatic Fringe Title"
  description="Display title on a transparent root: blur-focus entrance, red/blue fringe that settles then breathes, perspective bow, slow scale drift"
  variables={[]}
  meta={{"duration":6,"width":1920,"height":1080,"category":"Typography & Text","badge":"Stable","codeLines":204}}
  attribution={{"path":"registry/blocks/yt-prism-title","tags":["typography","title-card","creator"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/yt-prism-title/yt-prism-title.html"
>

<CatalogSlot slot="code">

```html yt-prism-title.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
