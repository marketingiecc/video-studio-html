...
<CatalogDetail
  previewSrc="/public/catalog/blocks/mk-clone-wall-transition.json"
  compositionId="mk-clone-wall-transition"
  compositionSrc="compositions/mk-clone-wall-transition.html"
  title="Text Clone Wall Transition"
  description="Overlay transition: a tiled word wall covers the frame, inverts via difference blending, and clears — hard-cut the content beneath while covered"
  variables={[]}
  meta={{"duration":2.4,"width":1920,"height":1080,"category":"CSS Transitions","badge":"Stable","codeLines":225}}
  attribution={{"path":"registry/blocks/mk-clone-wall-transition","tags":["transition","typography","wipe"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/mk-clone-wall-transition/mk-clone-wall-transition.html"
>

<CatalogSlot slot="code">

```html mk-clone-wall-transition.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
