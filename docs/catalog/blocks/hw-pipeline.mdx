...
<CatalogDetail
  previewSrc="/public/catalog/blocks/hw-pipeline.json"
  compositionId="hw-pipeline"
  compositionSrc="compositions/hw-pipeline.html"
  title="Hand-Drawn Flowchart"
  description="Wobbled boxes with handwritten labels joined by curved connectors, drawing on in sequence from a node list"
  variables={[]}
  meta={{"duration":7,"width":1920,"height":1080,"category":"Blocks","badge":"Stable","codeLines":317}}
  attribution={{"path":"registry/blocks/hw-pipeline","tags":["handwritten","diagram","data-viz","overlay"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/hw-pipeline/hw-pipeline.html"
>

<CatalogSlot slot="code">

```html hw-pipeline.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
