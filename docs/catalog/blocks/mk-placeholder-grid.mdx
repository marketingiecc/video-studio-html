...
<CatalogDetail
  previewSrc="/public/catalog/blocks/mk-placeholder-grid.json"
  compositionId="mk-placeholder-grid"
  compositionSrc="compositions/mk-placeholder-grid.html"
  title="Rounded Media Grid"
  description="N-up rounded-corner media grid (2-up, 3-up, 4-up, 3x2, hero plus two): per-cell inside-scale framing, staggered box-in entrance, slow settle"
  variables={[]}
  meta={{"duration":8,"width":1920,"height":1080,"category":"Blocks","badge":"Stable","codeLines":233}}
  attribution={{"path":"registry/blocks/mk-placeholder-grid","tags":["placeholder","media","grid","minimal"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/mk-placeholder-grid/mk-placeholder-grid.html"
>

<CatalogSlot slot="code">

```html mk-placeholder-grid.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
