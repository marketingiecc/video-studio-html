...
<CatalogDetail
  previewSrc="/public/catalog/blocks/hw-path-text.json"
  compositionId="hw-path-text"
  compositionSrc="compositions/hw-path-text.html"
  title="Text Along a Path"
  description="Handwriting flowing along any SVG path with a per-character reveal; the path is the only geometry input"
  variables={[]}
  meta={{"duration":6,"width":1920,"height":1080,"category":"Typography & Text","badge":"Stable","codeLines":194}}
  attribution={{"path":"registry/blocks/hw-path-text","tags":["handwritten","typography","path","overlay"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/hw-path-text/hw-path-text.html"
>

<CatalogSlot slot="code">

```html hw-path-text.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
