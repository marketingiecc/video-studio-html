...
<CatalogDetail
  previewSrc="/public/catalog/blocks/mk-callout-highlight.json"
  compositionId="mk-callout-highlight"
  compositionSrc="compositions/mk-callout-highlight.html"
  title="Word-Sweep Highlight"
  description="A sentence whose word-by-word emphasis is driven by a single scalar — tween it to sync the highlight with a voiceover"
  variables={[]}
  meta={{"duration":8,"width":1920,"height":1080,"category":"Captions","badge":"Stable","codeLines":156}}
  attribution={{"path":"registry/blocks/mk-callout-highlight","tags":["typography","karaoke","captions","minimal"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/mk-callout-highlight/mk-callout-highlight.html"
>

<CatalogSlot slot="code">

```html mk-callout-highlight.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
