...
<CatalogDetail
  previewSrc="/public/catalog/blocks/hw-title.json"
  compositionId="hw-title"
  compositionSrc="compositions/hw-title.html"
  title="Handwritten Title"
  description="Handwritten display text with a scalar-driven word-by-word highlight sweep and a seeded squiggle underline sized to the text; boils"
  variables={[]}
  meta={{"duration":6,"width":1920,"height":1080,"category":"Typography & Text","badge":"Stable","codeLines":257}}
  attribution={{"path":"registry/blocks/hw-title","tags":["handwritten","typography","title-card","overlay"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/hw-title/hw-title.html"
>
