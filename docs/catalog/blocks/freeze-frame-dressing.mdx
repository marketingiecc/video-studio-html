...
<CatalogDetail
  previewSrc="/public/catalog/blocks/freeze-frame-dressing.json"
  compositionId="freeze-frame-dressing"
  compositionSrc="compositions/freeze-frame-dressing.html"
  title="Freeze-Frame Dressing"
  description="Timeline-driven paper, tape, and flash dressing for a freeze-frame or background-removed subject"
  variables={[]}
  meta={{"duration":4,"width":1920,"height":1080,"category":"Social Overlays","badge":"Stable","codeLines":120}}
  attribution={{"path":"registry/blocks/freeze-frame-dressing","tags":["freeze-frame","cutout","scrapbook","paper","social","overlay","media-treatment-overlay"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/freeze-frame-dressing/freeze-frame-dressing.html"
>

<CatalogSlot slot="code">

```html freeze-frame-dressing.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
